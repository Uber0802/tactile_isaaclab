...
# modality. Encoder weights come from the ReWiND ckpt below and stay frozen.
...
FORGE_TACTILE_ENCODER_CKPT=/mnt/tank/uber/Tactile-Reward/checkpoints_isaaclab_balanced/isaaclab_overfit_epoch99.pth \
...
FORGE_TACTILE_SAVE_DIR=/mnt/tank/tactile/tactile_dataset/pegpickplace_baselineB2 \
./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py \
    ...
    --wandb-name PegInsert_PickPlace_baselineB2
