FORGE_TACTILE_REWARD_CKPT=/home/kim/ml/tactile-irl/tactile_isaaclab/box_stack_epoch19.pth \
FORGE_SAVE_TACTILE_FORCE_FIELD=1 \
FORGE_TACTILE_SAVE_DIR=./tactile_dataset/stack_bowl/tacReward \
...
./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py \
    ...
    --wandb-name Stack_bowl_tacReward
