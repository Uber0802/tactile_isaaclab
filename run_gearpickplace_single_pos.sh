...
# randomizer (base xy+yaw, gear xy+yaw, hand xy+orn) is zeroed so every
...
FORGE_TACTILE_SAVE_DIR=/mnt/tank/tactile/tactile_dataset/gearpickplace_single_pos \
./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py \
    ...
    --wandb-name GearMesh_PickPlace_single_pos
