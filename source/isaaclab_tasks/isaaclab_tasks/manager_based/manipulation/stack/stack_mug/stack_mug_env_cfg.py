...
LOCAL_MUG_USD = "./assets/Props/mug_sdf.usd"
...
class GelsightRewardsCfg(RewardsCfg):
    ...
    stack_object_z_reward_exp = RewTerm(
        ...
        params={
            ...
            "max_z_distance": 0.142, # 0.02442 0.142 0.1182 0.044
        },
        weight=1.0,
    )
...
@configclass
class FrankaStackMugEnvCfg(StackEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.stack_object = RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=(0.5, 0, 0.02442), rot=(1, 0, 0, 0)),
            spawn=sim_utils.UsdFileCfg(
                usd_path=LOCAL_MUG_USD,
