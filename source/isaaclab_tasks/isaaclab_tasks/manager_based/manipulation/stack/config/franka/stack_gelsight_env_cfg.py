    ...
    def __post_init__(self):
        ...
        self.scene.robot = FRANKA_PANDA_HIGH_PD_CFG.replace(
            ...
            spawn=sim_utils.UsdFileWithCompliantContactCfg(
                usd_path=LOCAL_PEG_INSERT_ROBOT_USD_PATH,
                activate_contact_sensors=True,
                rigid_props=FRANKA_PANDA_HIGH_PD_CFG.spawn.rigid_props,
                articulation_props=sim_utils.ArticulationRootPropertiesCfg(
                    enabled_self_collisions=False, solver_position_iteration_count=8, solver_velocity_iteration_count=0
                ),
                collision_props=FRANKA_PANDA_HIGH_PD_CFG.spawn.collision_props,
                compliant_contact_stiffness=1000.0,
                compliant_contact_damping=100.0,
                physics_material_prim_path=[
                    "left_elastomer_link",
        ...
        '''
        #self.scene.robot.actuators["panda_hand"].stiffness = 1e5
        #self.scene.robot.actuators["panda_hand"].damping = 1e3
        #self.scene.robot.actuators["panda_hand"].effort_limit = 200.0
