...
./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py \
    ...
    --wandb-name NutThread_PickPlace_baselineA_hard_success_-3.5_seed3 \
    agent.params.config.full_experiment_name=NutThread_PickPlace_baselineA_hard_success_-3.5_seed3 \
