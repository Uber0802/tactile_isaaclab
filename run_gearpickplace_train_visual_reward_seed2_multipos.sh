#!/bin/bash
# Train the ReWiND visual (RGB) reward model on the gear seed2 multipos rollouts.
#
...
#
# Usage:
#   GPU_ID=5 ./run_gearpickplace_train_visual_reward_seed2_multipos.sh
...
DATA_DIR=${DATA_DIR:-/mnt/scratch/tactile/gearpickplace_curriculum_seed2_paired_multipos}
CACHE_DIR=${CACHE_DIR:-/mnt/scratch/tactile/dino_cache/gear_seed2_multipos}
CKPT_DIR=${CKPT_DIR:-/mnt/lab-tank/tactile/Tactile-Reward/ckpt_visual/gear_seed2_multipos}
RUN_NAME=${RUN_NAME:-gear_rgb_seed2_multipos}
