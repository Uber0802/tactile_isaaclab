...
./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py \
    ...
    --wandb-name NutThread_PickPlace_baselineTacReward_hard_success_0.2_-3.5 \
    agent.params.config.full_experiment_name=NutThread_PickPlace_baselineTacReward_hard_success_0.2_-3.5 \
