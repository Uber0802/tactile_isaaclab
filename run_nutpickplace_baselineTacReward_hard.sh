...
FORGE_TACTILE_REWARD_CKPT=/mnt/lab-tank/uber/Tactile-Reward/exp_taskcompare/nut_scratch/nut_scratch_epoch12.pth \
...
./isaaclab.sh -p scripts/reinforcement_learning/rl_games/train.py \
    ...
    --wandb-name NutThread_PickPlace_baselineTacReward_hard \
    agent.params.config.full_experiment_name=NutThread_PickPlace_baselineTacReward_hard \
