...
parser.add_argument(
    "--sdf-resolution",
    type=int,
    default=1024, # Increased for thin walls
...
parser.add_argument(
    ...
    type=float,
    default=None,
    help="Mass to set on the rigid body in kg. If not specified, defaults to 0.3 scaled by target_scale^3 (physically-accurate volume scaling).",
)
