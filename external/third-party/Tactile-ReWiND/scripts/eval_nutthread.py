"""Evaluate a nutthread tactile reward ckpt on the 10-success + 10-fail holdout
set written by `train_nutthread.py` to `<ckpt_dir>/eval_holdout.json`.
...
Usage:
    python scripts/eval_nutthread.py \\
        --ckpt /mnt/tank/tactile/Tactile-Reward/checkpoints_nutthread_balanced/nutthread_epoch99.pth \\
        --instruction "pick up the nut and thread it onto the bolt" \\
        --output /mnt/tank/tactile/Tactile-Reward/nutthread_eval.png
"""
...
def main(args):
    ...
    ax.set_title(f"NutThread {mode_label} eval — {ckpt_label}\n"
...
if __name__ == "__main__":
    ...
    ap.add_argument("--output", default=None,
                    help="PNG path. Default: <ckpt_dir>/nutthread_eval[_train].png")
